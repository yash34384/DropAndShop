...
export const login = (rollNumber, password) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(`/api/v1/login`, { rollNumber, password }, config);
